...
public interface SettingsMapKeys {
    ...
    String fontNameNormal = "fontNameNormal";
    String fontNameHeader = "fontNameHeader";
    String fieldYPadding = "verticalPaddingBetweenFields";
    String dateFormatting = "appendedDateFormatting";
    String dateSpelledOut = "appendedDateSpelledOut";
